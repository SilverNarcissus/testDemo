...
public class DynamicSegmentSumTree {

  public static void main(String[] args) {
    DynamicSegmentSumTree segmentTree = new DynamicSegmentSumTree();
    segmentTree.modify(1,10,3);
    segmentTree.modify(2,2,2);
    segmentTree.modify(4,7,10);
